...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics g){
        if(running){
            ...
            g.drawString("Puntuacion: "+ pointsEaten, (SCREEN_WIDTH - metrics.stringWidth("Puntuacion: "+ pointsEaten))/2,g.getFont().getSize());
        }else {
            gameOver(g);
        }
    }
    ...
    public void checkCollisions(){
        ...
        //Verifica si la cabeza toca el borde de arriba
        if(y[0] < 0) {
            running = false;
        }
        //Verifica si la cabeza toca el borde de abajo
